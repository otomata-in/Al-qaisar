...
<a href="/admin/project/create" class="btn btn-success">New Project</a>
            <!-- Blog Grid ==== -->
                    ...
                    <div class="ttr-blog-grid-3 row" id="masonry">
                        ...
                        <div class="post action-card col-lg-4 col-md-6 col-sm-12 col-xs-12 m-b40 text-center">
                            <div class="recent-news">
                                ...
                                <a href="/admin/project/{{ $p->id }}" class="magnific-anchor"><img class="project-image" src="/storage/{{ $p->project_image }}" alt=""></a>
                                </div>
