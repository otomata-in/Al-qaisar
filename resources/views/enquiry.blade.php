	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 col-md-offset-1 animate-box">
				...
				<div class="row">
					<div class="col-md-18">
						<div class="contact-info-wrap-flex text-center">
							<div class="con-info">
								<p><span class="contact-icon"><i class="icon-location-2"></i>
									</span><br> Street No 891, Thakira Road, <br> Alkhor, Doha-Qatar 60560</p>
							</div>
							<div class="con-info">
								<p><span class="contact-icon"><i class="icon-phone3"></i></span>
									<br>
									<a href="tel:+974 74051111">+974 74051111</a><br>
									<a href="tel:+974 31327711">+974 31327711</a></p>
							</div>
							<div class="con-info">
								<p><span class="contact-icon"><i class="icon-envelope"></i>
									</span><br> <a href="mailto:alqaisartading@gmail.com">info<br>@al-qaisar.com </a></p>
							</div>
							<div class="con-info">
								<p><span class="contact-icon"><i class="icon-globe"></i><br>
									</span> <a href="/">al-qaisar.com</a></p>
							</div>
						</div>
					</div>
				</div>
